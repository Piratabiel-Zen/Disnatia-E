...
const CLASSES = [
  {
    id:'fogo',name:'Assassinos do Fogo Azul',icon:'🔥',color:'#1EC8FF',
    glow:'rgba(30,200,255,0.16)',role:'Assassino · DPS Furtivo',
    lore:`Nos antigos e brutais campos de batalha, onde a morte era constante, alguns guerreiros descobriram como sobreviver canalizando a energia vital que emanava dos corpos caídos. Eles absorviam não apenas a vida esvaída, mas a pura vontade de lutar e a fúria dos mortos. Esta energia manifestou-se como uma chama azul incandescente que queima dentro deles, fortalecendo músculos e reflexos a níveis sobre-humanos, permitindo-lhes mover-se com velocidade letal e desferir ataques devastadores antes mesmo de serem notados.`,
    passive:{name:'Energia Vital',desc:'A cada 3 rodadas ganha 2 pontos para incluir em quaisquer bônus de ação. +1 ponto armazenado por inimigo abatido (acumulativo), podendo ser usado a qualquer momento.'},
    normal:[
      {name:'Esquiva da Catedral',cost:2,cooldown:'4 rodadas',desc:'Esquiva de qualquer ataque ficando translúcido e completamente intangível. Não pode ser usada novamente por 4 rodadas.'},
      {name:'Golpe Cintilante',cost:2,cooldown:'3 rodadas',desc:'Estocada veloz que atravessa o alvo, fazendo-o sangrar: −1 de vida por rodada por 3 rodadas consecutivas.'},
      {name:'Clemência Letal',cost:2,cooldown:'4 rodadas',desc:'+2 em quaisquer atributos por 2 rodadas. Ao expirar, −2 nesses mesmos atributos por 2 rodadas.'},
    ],
    specials:[
      {name:'Olho da Mente',cost:3,cooldown:'4 rodadas',desc:'Vê os pontos fracos do oponente por membros do corpo, causando 2× o dano em uma parte específica escolhida.',req:3},
      {name:'Fúria Flamejante',cost:3,cooldown:'5 rodadas',desc:'Envolve-se em chamas azuis: +1 alcance, +2 dano e precisão, +0,5 dano em área/rodada. Após 2 rodadas ativo, superaquece — fica 2 rodadas completamente incapaz de agir.',req:7},
    ]
  },
  {
    id:'escarlate',name:'Cavaleiros Escarlate',icon:'🛡️',color:'#E8193C',
    glow:'rgba(232,25,60,0.16)',role:'Tanque · Protetor',
    lore:`A sua linhagem remonta a eras esquecidas, a povos que realizavam trabalhos braçais extremos nas profundezas da terra. Durante escavações, descobriram um minério enigmático: um rubi de cor escarlate incrivelmente denso. A exposição contínua e o suor derramado sobre o rubi criaram uma osmose biológica e mágica. O mineral fundiu-se com a genética destes trabalhadores, fazendo com que a sua própria pele se tornasse espessa, rígida e quase tão impenetrável quanto a rocha que outrora mineravam.`,
    passive:{name:'Pele de Rubi',desc:'Quando sem o escudo escarlate, a pele endurece. Ganha atributos bônus de defesa de acordo com a quantidade de inimigos ao redor.'},
    normal:[
      {name:'Reflexo Escarlate',cost:2,cooldown:'3 rodadas',desc:'Reflete 0,5× o dano recebido. Para cada inimigo ao redor, o maior valor refletido é duplicado.'},
      {name:'Lança Defensiva',cost:2,cooldown:'1 rodada',desc:'Arremessa o escudo no inimigo. Com resultado D18–20, pode atingir múltiplos inimigos. O escudo retorna à mão automaticamente.'},
      {name:'Investida Ágil',cost:2,cooldown:'2 rodadas',desc:'Troca resistência por velocidade: move-se 3 passos em 1 ação para proteger alguém ou fugir. −3 resistência por 2 rodadas.'},
    ],
    specials:[
      {name:'Provocação Extrema',cost:3,cooldown:'4 rodadas',desc:'Todos os inimigos ao redor focam em você. Todo dano recebido é reduzido em 30% enquanto o efeito durar (4 rodadas).',req:3},
      {name:'Modo Berserker',cost:3,cooldown:'4 rodadas',desc:'Troca toda a armadura por dano, força e alcance massivos. Fica imparável — mas exausto, sem poder usar habilidades por 4 rodadas.',req:7},
    ]
  },
  {
    ...
    normal:[
      ...
      {name:'Saque Rápido',cost:2,cooldown:'2 rodadas',desc:'Realiza um ataque a qualquer momento, mesmo fora do turno. Precisão reduzida em 2 pontos neste disparo.'},
      {name:'Foco Absoluto',cost:2,cooldown:'2 rodadas',desc:'Fica 1 rodada inteira sem atacar, apenas focando em um alvo. Garante acerto crítico automático na próxima rodada caso acerte.'},
    ],
    specials:[
      {name:'Precisão Celestial',cost:3,cooldown:'4 rodadas',desc:'Disparo crítico perfurante. O inimigo atingido perde −2 de vida por rodada pelos turnos seguintes.',req:3},
      {name:'Chuva Mortal',cost:3,cooldown:'5 rodadas',desc:'Múltiplos acertos simultâneos em uma área de 10–13 metros ao redor. Não atinge aliados.',req:7},
    ]
  },
  {
    id:'magos',name:'Magos do Prólogo do Céu',icon:'☄️',color:'#A855F7',
    glow:'rgba(168,85,247,0.16)',role:'Vidente · Mago Cósmico',
    lore:`Outrora humanos comuns, o seu destino mudou quando uma pena celestial caiu dos céus. O primeiro a tocá-la teve a sua mente expandida além da compreensão mortal, despertando o dom absoluto da clarividência. Ele não controlava o tempo, mas conseguia observá-lo. Ao ver os fragmentos do futuro da humanidade, fundou esta ordem mágica e escreveu as suas visões no lendário Livro da Mandíbula. Transmitem o conhecimento cósmico através de diagramas sagrados, cânticos e uma profunda ligação com as anomalias do universo.`,
    passive:{name:'Visão Profética',desc:'Podem ver brevemente acontecimentos futuros ou preverem eventos por pistas do cenário, concedendo pontos bônus de combate ao grupo.'},
    normal:[
      {name:'Fortitude Ígnia',cost:2,cooldown:'1× por combate',desc:'Um personagem aliado recebe +3 de defesa por 2 rodadas ao ser atingido. 1 uso por combate por jogador.'},
      {name:'Fluxo de Magia',cost:2,cooldown:'4 rodadas',desc:'Distribui parte da sua magia entre aliados em até 2m ao redor, buffando o dano deles em +2 por 4 rodadas.'},
      {name:'Telecinese',cost:2,cooldown:'variável',desc:'Controla objetos ao redor e os arremessa contra inimigos. Tempo varia conforme o objeto. Pessoas só com consentimento.'},
    ],
    specials:[
      {name:'Recuperação Divina',cost:3,cooldown:'4 rodadas',desc:'Remove todos os efeitos negativos de todos os aliados e cura uma quantidade de vida.',req:3},
      {name:'Flecha do Último Guardião',cost:3,cooldown:'5 rodadas',desc:'Invoca um arco gigante que dispara uma flecha com atributos de qualquer elemento escolhido, causando dano massivo em área.',req:7},
    ]
  },
  {
    id:'marfim',name:'Cientistas de Marfim',icon:'🧪',color:'#D4C5A9',
    glow:'rgba(212,197,169,0.16)',role:'Inventor · Gênio Adaptável',
    lore:`A origem desta linhagem começou com o primeiro grande alquimista da história. Através de anos de experimentação, ele sintetizou a "Pedra de Marfim" — o que as lendas chamam de Pedra Filosofal. Este objeto concedeu-lhe o conhecimento absoluto sobre física, química e tudo ainda por descobrir. Esta iluminação alterou o seu ADN. Todos os descendentes nascem com QI astronômico — um deles foi Nikola Tesla — criando maravilhas tecnológicas com sucata e compostos simples.`,
    ...
    specials:[
      {name:'O 1° Alquimista',cost:3,cooldown:'4 rodadas',desc:'Combina 4 a 5 itens criando algo novo e poderoso. Pode também disparar 1 tiro de tesla, atordoando o alvo.',req:3},
      {name:'Anti-Matéria',cost:3,cooldown:'6 rodadas',desc:'Transcende, invocando 1mg de antimatéria: dano crítico garantido + efeitos negativos (lentidão, tontura, lepra degenerativa) a cada 4 rodadas.',req:7},
    ]
  },
];

const PROLOGUE = [
  {type:'intro',text:'No início, não existia nada.'},
  {type:'pause',text:'E do nada ele surgiu — quem o nomeou? Ele mesmo.'},
  {type:'title',text:'*$!6;^@$+6~=´} (JhonKenteiker)'},
  {type:'body',text:'Jhon viu diante de si um universo vasto, lindo, porém vazio. E assim decidiu criar o sistema solar, e dele o mundo mais belo — nomeando-o Cosmum, a Terra dos mortais.'},
  {type:'body',text:'Nisso, ele criou as primeiras criaturas: já fortes, ágeis, adaptáveis, sobreviventes em qualquer cenário. Os dinossauros. Porém viu que dar-lhes tantas vantagens foi um erro.'},
  {type:'highlight',text:'E nisso ele criou o primeiro conceito de Reinício.'},
  {type:'body',text:'Uma grande bola de fogo atingiu o planeta, criando eventos irreversíveis e mudanças eternas. Do silêncio das cinzas surgiram os primeiros seres. Eles evoluíram. E a partir disso, o ser humano surgiu — não tão forte quanto os dinossauros, porém com uma capacidade cognitiva incomparável.'},
  {type:'divider',text:'— — —'},
...
const MILESTONES = [
  {year:'~400.000 AC',event:'Descoberta e controle do fogo',icon:'🔥'},
  {year:'~10.000 AC',event:'Revolução agrícola — os humanos se tornam sedentários',icon:'🌾'},
  {year:'~3.500 AC',event:'Surgimento das primeiras civilizações: Mesopotâmia e Egito',icon:'🏛️'},
  {year:'~3.000 AC',event:'Invenção da escrita cuneiforme',icon:'📜'},
  {year:'~500 AC',event:'Apogeu dos grandes impérios: Persa, Grego, Romano',icon:'⚔️'},
  {year:'Séc. XV',event:'Era das grandes navegações e descobrimento dos continentes',icon:'🌊'},
  {year:'Séc. XVIII',event:'Revolução Industrial — a máquina a vapor muda o mundo',icon:'⚙️'},
  {year:'1905',event:'Albert Einstein publica a Teoria da Relatividade',icon:'🧠'},
  {year:'1945',event:'Era Atômica — o poder de destruição da humanidade se torna real',icon:'☢️'},
  {year:'1969',event:'O primeiro ser humano pisa na Lua',icon:'🌕'},
  {year:'1990s',event:'Era digital — a internet conecta a humanidade globalmente',icon:'💻'},
  {year:'Séc. XXI',event:'Inteligência artificial: a humanidade cria inteligência',icon:'🤖'},
...
function StarField() {
  ...
  useEffect(() => {
    ...
    const stars = Array.from({length:200}, () => ({x:Math.random(),y:Math.random(),r:Math.random()*1.2+0.2,phase:Math.random()*Math.PI*2,spd:Math.random()*0.025+0.008}));
    const ps = [{x:0.10,y:0.04,c:'#1EC8FF'},{x:0.87,y:0.05,c:'#E8A020'},{x:0.48,y:0.025,c:'#A855F7'},{x:0.70,y:0.06,c:'#E8193C'}];
    let t = 0;
    const draw = () => {
      ctx.clearRect(0,0,canvas.width,canvas.height); t += 0.007;
      stars.forEach(s => { const a=0.2+0.5*Math.sin(t*s.spd*50+s.phase); ctx.beginPath(); ctx.arc(s.x*canvas.width,s.y*canvas.height,s.r,0,Math.PI*2); ctx.fillStyle=`rgba(255,255,255,${a})`; ctx.fill(); });
      ps.forEach((s,i) => {
        const a=0.55+0.45*Math.sin(t*1.1+i*0.8), px=s.x*canvas.width, py=s.y*canvas.height;
        ctx.save(); ctx.shadowColor=s.c; ctx.shadowBlur=14*a; ctx.globalAlpha=a;
        ctx.beginPath(); ctx.arc(px,py,2.8,0,Math.PI*2); ctx.fillStyle=s.c; ctx.fill(); ctx.restore();
        ctx.save(); ctx.globalAlpha=a*0.4; ctx.strokeStyle=s.c; ctx.lineWidth=0.8;
        ctx.beginPath(); ctx.moveTo(px-8,py); ctx.lineTo(px+8,py); ctx.stroke();
        ctx.beginPath(); ctx.moveTo(px,py-8); ctx.lineTo(px,py+8); ctx.stroke(); ctx.restore();
      });
...
function PrologueSection() {
  return (
    <div style={{maxWidth:720,margin:'0 auto',padding:'40px 24px 80px',animation:'fadeIn 0.6s ease'}}>
...
function ClassCard({cls}) {
  ...
  return (
    <div onClick={()=>setOpen(o=>!o)} style={{border:`1px solid ${open?cls.color+'55':'rgba(255,255,255,0.08)'}`,borderRadius:12,background:open?'rgba(10,12,28,0.95)':'rgba(8,10,22,0.8)',marginBottom:13,cursor:'pointer',transition:'all 0.3s',boxShadow:open?`0 0 28px ${cls.glow}`:'none',overflow:'hidden'}}>
      <div style={{padding:'15px 20px',display:'flex',alignItems:'center',gap:13}}>
        <span style={{fontSize:24}}>{cls.icon}</span>
        <div style={{flex:1}}>
          <div style={{fontFamily:'Cinzel,serif',fontSize:14,fontWeight:700,color:cls.color,letterSpacing:'0.03em'}}>{cls.name}</div>
          <div style={{fontSize:11,color:'#7B6D8A',marginTop:3,fontFamily:'Cinzel,serif',letterSpacing:'0.06em'}}>{cls.role}</div>
        </div>
        <div style={{color:'rgba(255,255,255,0.22)',fontSize:12,transform:open?'rotate(90deg)':'none',transition:'transform 0.3s'}}>▶</div>
      </div>
      {open&&(
        <div onClick={e=>e.stopPropagation()} style={{padding:'0 20px 20px',animation:'fadeIn 0.3s ease'}}>
          <div style={{width:'100%',height:1,background:`linear-gradient(90deg,${cls.color}44,transparent)`,marginBottom:16}}/>
          <p style={{fontSize:14,color:'#9A8A7A',lineHeight:1.85,fontStyle:'italic',margin:'0 0 20px'}}>{cls.lore}</p>
          <div style={{marginBottom:16}}>
            <div style={{fontSize:10,letterSpacing:'0.35em',color:'rgba(255,255,255,0.22)',fontFamily:'Cinzel,serif',marginBottom:7,textTransform:'uppercase'}}>Passiva</div>
            <div style={{background:`${cls.color}0D`,border:`1px solid ${cls.color}28`,borderRadius:8,padding:'10px 13px'}}>
              <div style={{fontFamily:'Cinzel,serif',fontSize:13,color:cls.color,fontWeight:600,marginBottom:4}}>{cls.passive.name}</div>
              <div style={{fontSize:13,color:'#8A7A6A',lineHeight:1.7}}>{cls.passive.desc}</div>
            </div>
          </div>
          <div style={{marginBottom:16}}>
            <div style={{fontSize:10,letterSpacing:'0.35em',color:'rgba(255,255,255,0.22)',fontFamily:'Cinzel,serif',marginBottom:7,textTransform:'uppercase'}}>Ataques Normais — 2 VC cada</div>
            <div style={{display:'flex',flexDirection:'column',gap:6}}>
              {cls.normal.map((a,i)=>(
                <div key={i} style={{background:'rgba(255,255,255,0.02)',border:'1px solid rgba(255,255,255,0.06)',borderRadius:8,padding:'9px 12px',display:'flex',gap:10,alignItems:'flex-start'}}>
                  <div style={{flex:1}}>
                    <div style={{fontFamily:'Cinzel,serif',fontSize:12,color:'#C8B8A0',fontWeight:600,marginBottom:3}}>{a.name}</div>
                    <div style={{fontSize:13,color:'#7A6A5A',lineHeight:1.65}}>{a.desc}</div>
                  </div>
                  <div style={{flexShrink:0,textAlign:'right'}}>
                    <div style={{fontSize:11,color:`${cls.color}BB`,fontFamily:'Cinzel,serif'}}>2 VC</div>
                    <div style={{fontSize:10,color:'rgba(255,255,255,0.18)',marginTop:2}}>⏱ {a.cooldown}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div>
            <div style={{fontSize:10,letterSpacing:'0.35em',color:'rgba(255,255,255,0.22)',fontFamily:'Cinzel,serif',marginBottom:7,textTransform:'uppercase'}}>Especiais — 3 VC cada</div>
            <div style={{display:'flex',flexDirection:'column',gap:6}}>
              {cls.specials.map((a,i)=>(
                <div key={i} style={{background:`${cls.color}09`,border:`1px solid ${cls.color}22`,borderRadius:8,padding:'9px 12px',display:'flex',gap:10,alignItems:'flex-start'}}>
                  <div style={{flex:1}}>
                    <div style={{display:'flex',alignItems:'center',gap:6,marginBottom:3}}>
                      <span style={{fontSize:11,color:cls.color}}>✦</span>
                      <span style={{fontFamily:'Cinzel,serif',fontSize:12,color:'#C8B8A0',fontWeight:600}}>{a.name}</span>
                    </div>
                    <div style={{fontSize:13,color:'#7A6A5A',lineHeight:1.65}}>{a.desc}</div>
                  </div>
                  <div style={{flexShrink:0,textAlign:'right'}}>
                    <div style={{fontSize:11,color:`${cls.color}BB`,fontFamily:'Cinzel,serif'}}>3 VC</div>
                    <div style={{fontSize:10,color:'rgba(255,255,255,0.18)',marginTop:2}}>⏱ {a.cooldown}</div>
                    <div style={{fontSize:10,color:'rgba(255,255,255,0.16)',marginTop:2}}>Nív {a.req}+</div>
                  </div>
                </div>
              ))}
            </div>
  ...
  return (
    <div style={{maxWidth:760,margin:'0 auto',padding:'40px 24px 80px',animation:'fadeIn 0.6s ease'}}>
      <div style={{textAlign:'center',marginBottom:32}}>
        ...
        <div style={{fontSize:12,color:'#4A4050',marginTop:9,fontFamily:'Cinzel,serif'}}>Clique em cada classe para revelar lore e habilidades</div>
...
function Vigos({value,color,onChange}) {
  return (
    <div style={{display:'flex',gap:7}}>
      {Array.from({length:5}).map((_,i)=>(
        <button key={i} onClick={()=>onChange(i<value?(i===value-1?0:i+1):i+1)}
          style={{width:23,height:23,borderRadius:'50%',border:`1.5px solid ${i<value?color:'rgba(255,255,255,0.13)'}`,background:i<value?color+'33':'transparent',cursor:'pointer',transition:'all 0.2s',padding:0,boxShadow:i<value?`0 0 6px ${color}55`:'none'}}>
          {i<value&&<span style={{display:'block',width:9,height:9,borderRadius:'50%',background:color,margin:'auto'}}/>}
        </button>
      ))}
    </div>
  );
      ...
      <div style={{padding:'16px 18px'}}>
        ...
        <div style={{display:'flex',gap:10,alignItems:'flex-end',marginBottom:16,flexWrap:'wrap'}}>
          <div style={{flex:1,minWidth:120}}>
            ...
            <input value={sheet.nome} onChange={e=>f('nome',e.target.value)} placeholder="Nome do personagem" style={{width:'100%'}}/>
          </div>
          <div>
            <label style={{fontSize:10,letterSpacing:'0.3em',color:'#5A5070',fontFamily:'Cinzel,serif',display:'block',marginBottom:5,textTransform:'uppercase'}}>Classe</label>
            <select value={sheet.classe} onChange={e=>f('classe',e.target.value)}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(138px,1fr))',gap:9,marginBottom:16}}>
          <div style={{background:'rgba(232,25,60,0.07)',border:'1px solid rgba(232,25,60,0.2)',borderRadius:10,padding:'12px 14px'}}>
            ...
            <div style={{marginTop:7,height:3,background:'rgba(255,255,255,0.06)',borderRadius:2}}>
              <div style={{height:'100%',width:`${(sheet.hp/25)*100}%`,background:'#E8193C',borderRadius:2,transition:'width 0.3s'}}/>
            </div>
        ...
        <div style={{marginBottom:14,display:'flex',gap:9,flexWrap:'wrap'}}>
          {cls.specials.map((sp,i)=>{
            ...
            return (
              <button key={i} onClick={()=>f(key,!unlocked)}
                style={{display:'flex',alignItems:'center',gap:7,padding:'6px 12px',borderRadius:7,border:`1px solid ${unlocked?cls.color+'55':'rgba(255,255,255,0.09)'}`,background:unlocked?`${cls.color}14`:'rgba(255,255,255,0.02)',cursor:canUnlock?'pointer':'not-allowed',opacity:canUnlock?1:0.5,transition:'all 0.2s'}}>
...
function SheetsSection() {
  ...
  useEffect(()=>{
    const data = storageGet('disnastia-sheets-v3');
    if (data) setSheets(data);
    setLoaded(true);
  },[]);
  const save = s => { setSheets(s); storageSet('disnastia-sheets-v3', s); };
  const add = () => { if(sheets.length>=5) return; save([...sheets,newSheet(Date.now())]); };
  const upd = (id,d) => save(sheets.map(s=>s.id===id?d:s));
  const del = id => save(sheets.filter(s=>s.id!==id));
  return (
    <div style={{maxWidth:760,margin:'0 auto',padding:'40px 24px 80px',animation:'fadeIn 0.6s ease'}}>
      <div style={{textAlign:'center',marginBottom:32}}>
        ...
        <div style={{width:60,height:1,background:'linear-gradient(90deg,transparent,rgba(30,200,255,0.6),transparent)',margin:'16px auto 0'}}/>
      </div>
      {!loaded&&<div style={{textAlign:'center',color:'#5A5070',fontFamily:'Cinzel,serif',fontSize:13}}>Carregando...</div>}
      {loaded&&sheets.length===0&&(
        <div style={{textAlign:'center',padding:38,border:'1px dashed rgba(255,255,255,0.07)',borderRadius:12}}>
          <div style={{fontSize:30,marginBottom:10}}>✦</div>
          <div style={{fontFamily:'Cinzel,serif',fontSize:13,color:'#6A5A7A'}}>Nenhum personagem criado.</div>
          <div style={{fontSize:12,marginTop:5,color:'#4A4050'}}>Adicione os heróis que enfrentarão a profecia.</div>
        </div>
      )}
      ...
      {sheets.length<5&&(
        <button onClick={add}
          ...
          onMouseOut={e=>e.currentTarget.style.borderColor='rgba(255,255,255,0.11)'}
          style={{width:'100%',padding:13,borderRadius:10,border:'1px dashed rgba(255,255,255,0.11)',background:'rgba(255,255,255,0.02)',color:'#7B6D8A',cursor:'pointer',fontFamily:'Cinzel,serif',fontSize:12,letterSpacing:'0.08em',transition:'border-color 0.2s'}}>
          + Adicionar Personagem ({sheets.length}/5)
        </button>
      )}
    </div>
  );
...
function RulesSection() {
  ...
  return (
    <div style={{maxWidth:720,margin:'0 auto',padding:'40px 24px 80px',animation:'fadeIn 0.6s ease'}}>
      ...
      {RULES_DATA.map((r,i)=>(
        <div key={i} style={{marginBottom:9,border:'1px solid rgba(255,255,255,0.07)',borderRadius:11,overflow:'hidden',background:'rgba(8,10,22,0.8)'}}>
          <button onClick={()=>setOpen(open===i?-1:i)}
            ...
            <span style={{fontFamily:'Cinzel,serif',fontSize:13,color:'#C8B8A0',fontWeight:600,flex:1}}>{r.title}</span>
            <span style={{color:'rgba(255,255,255,0.2)',transform:open===i?'rotate(90deg)':'none',transition:'transform 0.3s'}}>▶</span>
          </button>
          {open===i&&(
            <div style={{padding:'0 18px 16px',borderTop:'1px solid rgba(255,255,255,0.05)',animation:'fadeIn 0.3s ease'}}>
              <div style={{height:10}}/>
              {r.body.split('\n').map((line,j)=>{
                if(!line.trim()) return <div key={j} style={{height:6}}/>;
                const isBullet=line.startsWith('•');
                const isHead=!isBullet&&line.length<55&&!line.includes('→')&&line.endsWith(':');
                return <p key={j} style={{margin:'0 0 5px',fontSize:14,lineHeight:1.8,color:isHead?'#C8B8A0':isBullet?'#9A8A7A':'#8A7A6A',fontFamily:isHead?'Cinzel,serif':'inherit',fontWeight:isHead?600:400,paddingLeft:isBullet?12:0}}>{line}</p>;
              })}
            </div>
          )}
        </div>
      ...
      <div style={{display:'flex',gap:8,marginBottom:26,justifyContent:'center'}}>
        {['📜 Marcos & Profecia','◈ As Seis Entidades'].map((t,i)=>(
          <button key={i} onClick={()=>setPage(i)}
            style={{padding:'7px 18px',borderRadius:20,fontFamily:'Cinzel,serif',fontSize:11,letterSpacing:'0.07em',border:page===i?'1px solid rgba(168,85,247,0.5)':'1px solid rgba(255,255,255,0.08)',background:page===i?'rgba(168,85,247,0.12)':'transparent',color:page===i?'#C8A8E8':'#5A4A6A',cursor:'pointer',transition:'all 0.2s'}}>{t}
          </button>
        ))}
      </div>
      ...
      {page===0&&(
        <div style={{animation:'fadeIn 0.4s ease'}}>
          ...
          <div style={{marginTop:26,padding:'22px',border:'1px solid rgba(232,25,60,0.28)',borderRadius:12,background:'rgba(232,25,60,0.05)'}}>
            ...
            <p style={{fontSize:14,color:'#B09090',lineHeight:1.85,margin:0,textAlign:'center',fontStyle:'italic'}}>
...
function CronicasSection() {
  ...
  useEffect(()=>{
    const data = storageGet('disnastia-cronicas-v2');
    if (data) setEntries(data);
    setLoaded(true);
  },[]);
  const save = e => { setEntries(e); storageSet('disnastia-cronicas-v2', e); };
  const add = () => { const e=newEntry(Date.now()); save([e,...entries]); setOpen(e.id); };
  const upd = (id,d) => save(entries.map(e=>e.id===id?d:e));
  const del = id => { save(entries.filter(e=>e.id!==id)); if(open===id) setOpen(null); };
  return (
    <div style={{maxWidth:760,margin:'0 auto',padding:'40px 24px 80px',animation:'fadeIn 0.6s ease'}}>
      <div style={{textAlign:'center',marginBottom:28}}>
      ...
      {loaded&&(
        <>
          ...
          {entries.length===0&&(
            <div style={{textAlign:'center',padding:38,border:'1px dashed rgba(255,255,255,0.07)',borderRadius:12}}>
              <div style={{fontSize:30,marginBottom:10}}>📜</div>
              <div style={{fontFamily:'Cinzel,serif',fontSize:13,color:'#6A5A7A'}}>Nenhuma crônica registrada.</div>
              <div style={{fontSize:12,marginTop:5,color:'#4A4050'}}>Os acontecimentos de Cosmum aguardam ser narrados.</div>
            </div>
          )}
          {entries.map(entry=>(
            <div key={entry.id} style={{border:'1px solid rgba(255,255,255,0.08)',borderRadius:11,marginBottom:11,overflow:'hidden',background:'rgba(8,10,22,0.85)'}}>
              <div onClick={()=>setOpen(open===entry.id?null:entry.id)} style={{padding:'13px 17px',display:'flex',alignItems:'center',gap:12,cursor:'pointer',userSelect:'none'}}>
                ...
                <div style={{flex:1}}>
                  ...
                  <div style={{fontSize:11,color:'#5A5070',marginTop:2,display:'flex',gap:10}}>
                    {entry.sessao&&<span>Sessão {entry.sessao}</span>}
              ...
              {open===entry.id&&(
                <div style={{padding:'0 17px 17px',borderTop:'1px solid rgba(255,255,255,0.05)',animation:'fadeIn 0.3s ease'}}>
                  ...
                  <div style={{display:'grid',gridTemplateColumns:'1fr 80px',gap:9,marginBottom:11}}>
                    <div>
                      <label style={{fontSize:10,letterSpacing:'0.3em',color:'#5A5070',fontFamily:'Cinzel,serif',display:'block',marginBottom:5,textTransform:'uppercase'}}>Título</label>
                      <input value={entry.titulo} onChange={e=>upd(entry.id,{...entry,titulo:e.target.value})} placeholder="Nome desta crônica..." style={{width:'100%'}}/>
                    </div>
                    <div>
                      <label style={{fontSize:10,letterSpacing:'0.3em',color:'#5A5070',fontFamily:'Cinzel,serif',display:'block',marginBottom:5,textTransform:'uppercase'}}>Sessão</label>
                      <input value={entry.sessao} onChange={e=>upd(entry.id,{...entry,sessao:e.target.value})} placeholder="Nº" style={{width:'100%'}}/>
                    </div>
                  </div>
                  <div>
                    ...
                    <textarea value={entry.conteudo} onChange={e=>upd(entry.id,{...entry,conteudo:e.target.value})}
                      placeholder={"Narre aqui os acontecimentos desta sessão...\n\nDescreva ações dos personagens, NPCs, inimigos, revelações importantes, decisões que moldaram Cosmum e todos os momentos épicos que merecem ser eternizados."}
                      rows={13} style={{width:'100%',resize:'vertical',lineHeight:1.85}}/>
                  </div>
  ...
  return (
    <div style={{height:'100vh',overflow:'hidden',display:'flex',flexDirection:'column',background:'#04060F',color:'#C8B8A0',fontFamily:"'Crimson Text',Georgia,serif",position:'relative'}}>
      ...
      <header style={{position:'relative',zIndex:10,textAlign:'center',padding:'18px 24px 13px',borderBottom:'1px solid rgba(255,255,255,0.05)',background:'linear-gradient(180deg,rgba(4,6,15,0.98),rgba(4,6,15,0.92))',backdropFilter:'blur(8px)'}}>
        <div style={{fontSize:9,letterSpacing:'0.5em',color:'#4A3A5A',fontFamily:'Cinzel,serif',marginBottom:5,textTransform:'uppercase'}}>Cosmum · O Livro da Mandíbula · Vigos Cósmicos</div>
      ...
      <nav style={{position:'relative',zIndex:10,display:'flex',justifyContent:'center',gap:3,padding:'9px 14px',background:'rgba(4,6,15,0.9)',borderBottom:'1px solid rgba(255,255,255,0.04)',flexWrap:'wrap'}}>
        {TABS.map(t=>(
          <button key={t.id} onClick={()=>setTab(t.id)}
            style={{padding:'6px 12px',borderRadius:6,cursor:'pointer',fontFamily:'Cinzel,serif',fontSize:11,letterSpacing:'0.06em',border:tab===t.id?'1px solid rgba(168,85,247,0.5)':'1px solid transparent',background:tab===t.id?'rgba(168,85,247,0.12)':'transparent',color:tab===t.id?'#C8A8E8':'#5A4A6A',transition:'all 0.2s'}}>
            {t.icon} {t.label}
          </button>
        ))}
      </nav>
