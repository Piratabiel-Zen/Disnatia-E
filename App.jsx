...
  // ⚙️ TECNOLÓGICOS / STEAMPUNK / FUTURISTAS
...
      {/* Grid 3 colunas simétricas: esquerda | silhueta | direita */}
...
    const danoValue=a.dano||a.roll||''; // aceita .dano (novo) ou .roll (legado)
    return(
...
          {/* DANO — agora exibido para TODAS as habilidades que tiverem o campo */}
...
  if(!masterMode){
    return(
      <div style={{maxWidth:760,margin:'0 auto',padding:'80px 24px',textAlign:'center',animation:'fadeIn 0.6s ease'}}>
        <div style={{fontSize:48,marginBottom:16,opacity:0.6}}>🔒</div>
        <h2 style={{fontFamily:'Cinzel Decorative,serif',fontSize:24,color:'#E8193C',fontWeight:700,margin:0,textShadow:'0 0 20px rgba(232,25,60,0.4)'}}>Acesso Restrito ao Mestre</h2>
        <div style={{fontSize:14,color:'#9A8A7A',marginTop:12,fontFamily:'Cinzel,serif',letterSpacing:'0.05em'}}>As fichas dos inimigos estão ocultas nas sombras.</div>
...
          {open===page.id&&(
            <div style={{padding:'0 17px 17px',borderTop:'1px solid rgba(168,85,247,0.1)',animation:'fadeIn 0.3s ease'}}>
              <div style={{height:11}}/>
              {masterMode?(<>
