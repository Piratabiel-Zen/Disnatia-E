...
// quatro listeners realtime (game/presence/items/enemies) continuavam vivos mesmo
// invisíveis. Eles agora existem apenas nas superfícies imersivas e religam
// imediatamente ao voltar para Sessão / Mapa Múndi / Mapa de Batalha.
