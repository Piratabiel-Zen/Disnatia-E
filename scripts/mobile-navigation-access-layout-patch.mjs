...
if (!exp.includes(EXP_MARKER)) {
  ...
  exp = exp.slice(0,lastNavMap) + 'mobileAllowedGroups20260910.map(group=>' + exp.slice(lastNavMap + 'NAV_GROUPS.map(group=>'.length);
...
for (const marker of [APP_MARKER, EXP_MARKER, CSS_MARKER, 'MOBILE_ALLOWED_NAV_IDS', 'mobileAllowedGroups20260910', "mobile ? 'fichas'", 'z-index:860']) {
